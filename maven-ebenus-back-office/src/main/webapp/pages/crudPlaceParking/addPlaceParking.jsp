			...
			<section>
				<div class="content">
					<div class="User quest">
						...
						<form action="${pageContext.request.contextPath}/AddPlaceParkingServlet"
							...
							<div class="account-container row">
								<fieldset class=" common-form-controls col-md-3">
									<div class="sel inputwrapper">
										<label for="immat"> Occupant </label> <select
											name="immat" id="immat">
									...
									<div class="input-wrapper">
										...
										<input value="${next_num}" autocomplete="num" name="num" id="num"
											   type="text">
									</div>
								</fieldset>
