 ...
 */
@WebServlet(name = "/DeleteReportServlet", urlPatterns = {"/DeleteReportServlet"})
public class DeleteReportServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		/* Delete selected car */
		Integer reportID = Integer.parseInt(request.getParameter("report"));
		Report report = service.getReportDao().findReportById(reportID);
		service.getReportDao().deleteReport(report);
		log.debug("Report deleted");
		response.sendRedirect(this.getServletContext().getContextPath() + "/LogsServlet");
	}
