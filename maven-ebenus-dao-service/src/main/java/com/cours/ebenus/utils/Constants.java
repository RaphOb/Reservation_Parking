...
public class Constants {
    ...
    public static java.io.File wd = new File(".");
//    public static java.io.File CREDENTIALS_FILE_PATH = new java.io.File(Constants.wd.getAbsolutePath() + "/src/main/java/com/cours/ebenus/credentials/keys.json");
//    public static java.io.File CREDENTIALS_FILE_PATH = new java.io.File("./src/main/java/com/cours/ebenus/credentials/keys.json");
