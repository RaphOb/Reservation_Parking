...
INSERT INTO Utilisateur(civilite,prenom,nom,idRole,email ,motPasse) VALUES ('Mr','Xavier','Petit',(SELECT idRole FROM Role WHERE identifiant LIKE  'Standard'),'xavier.dupont@gmail.com','passw0rd');
INSERT INTO Utilisateur(civilite,prenom,nom,idRole,email ,motPasse) VALUES ('Mr','Thierry','Petit',(SELECT idRole FROM Role WHERE identifiant LIKE  'Standard'),'thierry.marec@gmail.com','passw0rd');
