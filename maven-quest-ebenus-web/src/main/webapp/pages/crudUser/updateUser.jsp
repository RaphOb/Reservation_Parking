    ...
    <section>
        <div class="content">
            <div class="User quest">
               ...
               <h3>Bonjour </h3> <c:out value = "${bis.getNom}"/> <c:out value = "${bis.getPrenom()}"/>
                  <c:out value = "${user.getIdUtilisateur()}"/>
                vous pouvez mettre à jour vos données :
                <form action="${pageContext.request.contextPath}/UpdateUserServlet" method="Post" id="customer-info-form" class="no-gutters">
